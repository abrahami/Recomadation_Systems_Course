...
data = loader_obj.load(category='hotelstravel', d_train_all_categories=False)
...
print "The RMSE of the test data-set is {}, the MAE is {}".format(eval_obj.rmse, eval_obj.mae)
